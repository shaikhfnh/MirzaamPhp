...
return [
    ...
    //Why-Visit Page
     'whyvisit_eyebrow'        => 'For Visitors',
    'whyvisit_title'          => 'Why Visit',
    'whyvisit_title_accent'   => 'Mirzaam',
    'whyvisit_intro'          => 'Mirzaam is not just an exhibition — it is a unique experience that blends innovation and creativity in the world of interior design. The exhibition gives you the opportunity to communicate directly with experts, obtain specialized advice to improve your home, and discover a variety of luxurious products and materials that add a special touch to your personal space.',
 
    // 4 value cards
    'whyvisit_card1_tag'      => 'Value',
    'whyvisit_card1_title'    => 'View the latest trends',
    'whyvisit_card1_desc'     => 'Mirzaam offers visitors an opportunity to learn about the latest trends and innovations in the field of interior design by showcasing the work of local and international designers.',
 
    'whyvisit_card2_tag'      => 'Network',
    'whyvisit_card2_title'    => 'Communicate with experts',
    'whyvisit_card2_desc'     => 'Visitors can interact directly with interior designers and industry experts to obtain specialized advice and guidance to renovate or improve their own spaces.',
 
    'whyvisit_card3_tag'      => 'Luxury',
    'whyvisit_card3_title'    => 'Luxury products',
    'whyvisit_card3_desc'     => 'The exhibition offers a variety of luxury products and materials — from furniture and accessories to decorations — helping visitors choose the best for their homes.',
 
    'whyvisit_card4_tag'      => 'Concept',
    'whyvisit_card4_title'    => 'An inspiring environment',
    'whyvisit_card4_desc'     => 'Mirzaam offers an inspiring environment where visitors can get inspiration from new and innovative ideas to apply in their personal projects.',
 
    // Feature sections
    'whyvisit_food_title'     => 'Food & Coffee',
    'whyvisit_food_desc'      => 'Mirzaam offers an integrated experience for visitors by providing a special corner for restaurants and cafés where they can enjoy their time in a comfortable way. This corner enhances visitors\' experience by helping them relax and enjoy their time between tours of the exhibition, adding a touch of comfort to their visit.',
 
    'whyvisit_kids_title'     => 'Kids Area',
    'whyvisit_kids_desc'      => 'Mirzaam always pays special attention to families by providing a dedicated children\'s and nursery section, managed by professionals to make Mirzaam comforting and fun even for the little ones. This section allows parents to enjoy the exhibition experience comfortably, knowing that their children are in safe hands.',
 
    'whyvisit_prizes_title'   => 'Prizes & Giveaways',
    'whyvisit_prizes_desc'    => 'Shoppers at Mirzaam also had great chances of winning from a pool of grand prizes — including a state-of-the-art vehicle from Volvo and cash prizes of over 7,000 KD.',
 
    'whyvisit_workshops_title'  => 'Workshops & Talks',
    'whyvisit_workshops_desc'   => 'We offer a variety of lectures and workshops aimed at enhancing knowledge and skills in the field of interior design. These workshops are led by a group of successful experts and designers, who share their experiences and innovative ideas with visitors.',
    'whyvisit_workshops_desc2'  => 'The workshops provide practical opportunities for learning and application, helping participants develop their skills and implement new ideas in their own projects. Whether you are a beginner or a professional, you will find these lectures and workshops will inspire you and enable you to raise the level of your designs.',
    'whyvisit_workshops_cta'    => 'Visit Design Talks',
 
    // Final CTA
    'whyvisit_cta_eyebrow'    => 'Ready to experience it',
    'whyvisit_cta_title'      => 'Join us at Mirzaam 2026',
    'whyvisit_cta_desc'       => 'Five days of inspiration, discovery, and connection — under one roof at Kuwait International Fair.',
    'whyvisit_cta_button'     => 'Plan Your Visit',
 
    // Section eyebrow
    'whyvisit_experiences'    => 'On-Site Experiences',
    ...
    //Plan Your Trip Page
    'plantrip_eyebrow'         => 'For Visitors',
    'plantrip_title'           => 'Plan Your',
    'plantrip_title_accent'    => 'Trip',
    'plantrip_intro_tag'       => 'Expo Guide 2026',
    'plantrip_intro_heading'   => 'Your guide to visiting Mirzaam Expo in Kuwait',
    'plantrip_intro_body'      => 'Begin a new and enjoyable adventure in Kuwait by visiting Mirzaam Expo, where you will discover the world of innovative interior design and be inspired by new ideas for your home. Give yourself the opportunity to enjoy a unique adventure full of inspiration in Kuwait.',
 
    // Stat tiles
    'plantrip_stat1_value'     => '15',
    'plantrip_stat1_unit'      => 'min',
    'plantrip_stat1_label'     => 'From Airport',
    'plantrip_stat2_value'     => '3K+',
    'plantrip_stat2_label'     => 'Parking Bays',
    'plantrip_stat3_value'     => '5',
    'plantrip_stat3_unit'      => 'days',
    'plantrip_stat3_label'     => 'Event Duration',
    'plantrip_stat4_value'     => '200+',
    'plantrip_stat4_label'     => 'Exhibitors',
 
    // Venue
    'plantrip_venue_tag'       => 'Location',
    'plantrip_venue_title'     => 'The Venue',
    'plantrip_venue_body'      => 'The Kuwait International Fairground is in Mishref, serving as a strategic hub for commercial activities in Kuwait. It is considered one of the largest and best-equipped venues for hosting a large-scale exhibition like Mirzaam. Its large spaces, open halls, and strategic location make it the ideal choice for a unique experience.',
    'plantrip_venue_quote'     => 'Mirzaam is distinguished by its location in the Mishref area, which contains many commercial activities and events throughout the year.',
 
    // Logistics
    'plantrip_logistics_tag'   => 'How to Get There',
    'plantrip_logistics_title' => 'Arriving at Mirzaam',
    'plantrip_arrival1_tag'    => 'Arrival 01',
    'plantrip_arrival1_title'  => 'By Air',
    'plantrip_arrival1_desc'   => 'Kuwait International Airport and Kuwait Airways provide convenient flights to more than 100 global destinations. Once you arrive, KIF is a simple 15-minute drive away.',
    'plantrip_arrival2_tag'    => 'Arrival 02',
    'plantrip_arrival2_title'  => 'Driving & Parking',
    'plantrip_arrival2_desc'   => 'Head north from the airport, follow Route 50 to the Sixth Ring Road, then take the 208 Road to KIF. Free, ample parking is available on-site upon arrival.',
    'plantrip_arrival2_cta'    => 'Open in Google Maps',
 
    // Tips
    'plantrip_tips_tag'        => 'Before You Visit',
    'plantrip_tips_title'      => 'Good to Know',
    'plantrip_tip1_title'      => 'Free Parking',
    'plantrip_tip1_desc'       => 'Over 3,000 parking spaces available on-site, free for all visitors.',
    'plantrip_tip2_title'      => 'Free Entry',
    'plantrip_tip2_desc'       => 'Admission to the exhibition is completely free for all visitors of all ages.',
    'plantrip_tip3_title'      => 'Daily Hours',
    'plantrip_tip3_desc'       => 'The exhibition is open daily from 10:00 AM to 10:00 PM throughout the 5-day event.',
    'plantrip_tip4_title'      => 'Family Friendly',
    'plantrip_tip4_desc'       => 'Dedicated kids area, family rest zones, and stroller-friendly halls.',
 
    // Map
    'plantrip_map_tag'         => 'Find Us',
    'plantrip_map_title'       => 'On the Map',
    'plantrip_map_desc'        => 'Kuwait International Fair, Hall 5 & 6, Mishref, Kuwait City.',
 
    // Final CTA
    'plantrip_cta_eyebrow'     => 'Ready to visit',
    'plantrip_cta_title'       => 'See you at Mirzaam 2026',
